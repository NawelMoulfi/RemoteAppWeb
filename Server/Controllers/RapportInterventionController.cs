...
namespace RemoteAppApi.Controllers
{
    ...
    public class RapportInterventionController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateClient([FromBody] RapportInterventionDto RapportIntervention)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateClient([FromBody] RapportInterventionDto RapportIntervention)
        {
            if (RapportIntervention == null)
                return BadRequest();
