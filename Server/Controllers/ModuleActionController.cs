...
namespace RemoteAppApi.Controllers
{
    ...
    public class ModuleActionController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateModuleAction([FromBody] ModuleActionDto moduleaction)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateModuleAction([FromBody] ModuleActionDto moduleaction)
        {
            if (moduleaction == null)
                return BadRequest();
        ...
        public async Task<IActionResult> GetResourceAction([FromQuery] ResourceActionParameters parameters)
        {
            ...
            Shared.Dto.Action action = parameters.Action;
        ...
        public async Task<IActionResult> GetModuleActionsByResource(Shared.Dto.Resource resource)
        {
        ...
        public async Task<IActionResult> GetActionsByResource(Shared.Dto.Resource resource)
        {
