...
namespace RemoteAppApi.Controllers
{
    ...
    public class ModuleActionRoleController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateModule([FromBody] ModuleActionRole moduleActionRole)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateModuleActionRole([FromBody] ModuleActionRole moduleActionRole)
        {
            if (moduleActionRole == null)
                return BadRequest();
