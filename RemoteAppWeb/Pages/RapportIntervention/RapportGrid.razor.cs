...
public partial class RapportGrid : ComponentBase
{
    ...
    public List<RemoteApp.Data.Models.RapportIntervention> RapportInterventions { set; get; }
    ...
    public RemoteApp.Data.Models.RapportIntervention CurrentRapport = new RemoteApp.Data.Models.RapportIntervention();
    ...
    async Task OpenMaterielPopup(MouseEventArgs args, RemoteApp.Data.Models.RapportIntervention rapportIntervention)
    {
    ...
    void Grid_CustomizeEditModel(GridCustomizeEditModelEventArgs e) {
        var model = e.DataItem as RemoteApp.Data.Models.RapportIntervention;
        if (model == null)
        {
            model = new RemoteApp.Data.Models.RapportIntervention();
        }
        e.EditModel = model;
    }
    async Task Grid_EditModelSaving(GridEditModelSavingEventArgs e) {
        var rapport = (RemoteApp.Data.Models.RapportIntervention)e.EditModel;
        if(e.IsNew)
        {
    ...
    async Task Grid_DataItemDeleting(GridDataItemDeletingEventArgs e) {
        var rapport = e.DataItem as RemoteApp.Data.Models.RapportIntervention;
    ...
    public async Task RefreshRapports() {
        RapportInterventions = (List<RemoteApp.Data.Models.RapportIntervention>)await RapportService.GetAllRepports();
