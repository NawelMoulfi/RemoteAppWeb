...
namespace RemoteAppWeb.Pages
{
    public class LoginModel : PageModel
    {
     ...
     /// <summary>
     ///   private readonly RevalidatingIdentityAuthenticationStateProvider authenticationStateProvider;
     /// </summary>
            ...
            else
            {
               ...
               // var user = ; //LoginManager.FindUser(UserLogin, Password, isSuperUser);
                var expiresUtc = user.UserMaxCapacity == 0
                    ...
                    //await authenticationStateProvider.SetAuthenticationStateAsync(principal);
