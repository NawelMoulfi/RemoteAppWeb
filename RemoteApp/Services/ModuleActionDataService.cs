...
namespace RemoteApp.Services
{
    public class ModuleActionDataService : IModuleActionDataService
    {
        ...
        public async Task<IEnumerable<Data.Models.Action>> GetActionsByResource(Resource resource)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var Actions = await JsonSerializer.DeserializeAsync<List<Data.Models.Action>>(
                    responseStream,
                    new JsonSerializerOptions { PropertyNameCaseInsensitive = true }
                );


                return (IEnumerable<Data.Models.Action>)Actions;
            }
            else
            {
                return new List<Data.Models.Action>();
            }
        }
